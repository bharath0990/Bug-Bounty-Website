...
import { Shield, BookOpen, Users, Award, Clock, Star, CheckCircle, ArrowRight, Menu, X, Instagram, Twitter, Linkedin, Youtube, Github } from 'lucide-react';
...
function App() {
  ...
  const socialLinks = [
    { icon: Instagram, href: "https://instagram.com/ethicalhackermurari", label: "Instagram" },
    { icon: Twitter, href: "https://twitter.com/ethicalhackermurari", label: "Twitter" },
    { icon: Linkedin, href: "https://linkedin.com/in/ethicalhackermurari", label: "LinkedIn" },
    { icon: Youtube, href: "https://youtube.com/@ethicalhackermurari", label: "YouTube" },
    { icon: Github, href: "https://github.com/ethicalhackermurari", label: "GitHub" }
  ];
